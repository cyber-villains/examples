...
def check_domains(domains: list, your_domain: str) -> None:
    ...
    for domain_obj in domains:
        # todo: Implement your own domain handling. e.g...
        # - put this domain on a message queue
        # - handle metrics and/or alerting in separate threads
        # - write the domain to a log file
